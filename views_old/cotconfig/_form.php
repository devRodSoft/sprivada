...
<div class="cotconfig-form">

    <?php $form = ActiveForm::begin(['id'=>'formulario']); ?>
    
      <?=  $form->field($model, 'cotconfig')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'tb1')->widget(TinyMce::className(), [
    'options' => ['rows' => 6],
    'language' => 'es',
    'clientOptions' => [
        'plugins' => [
    ...
    <?= $form->field($model, 'tb2')->widget(TinyMce::className(), [
    'options' => ['rows' => 6],
    'language' => 'es',
    'clientOptions' => [
        'plugins' => [
